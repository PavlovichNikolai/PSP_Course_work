...
import contoller.ShowProfitController;

import javax.swing.*;
import java.util.List;
import java.util.Vector;

public class ShowProfitWindow extends JFrame implements BaseView {
    private JTable table = new JTable();
    private JButton backBtn = new JButton("Back");
    private Vector<String> columnNames = new Vector<>();

    private ShowProfitController controller = new ShowProfitController();

    ShowProfitWindow(int id) {
        super("Прибыль");
