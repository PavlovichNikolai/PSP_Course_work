...
import contoller.InsertExpensesController;

import javax.swing.*;
import java.awt.*;

public class InsertExpensesWindow extends JFrame implements BaseView {
    private InsertExpensesController controller = new InsertExpensesController();
    ...
    public void initWindow() {
        ...
        insertBtn.addActionListener(e -> {
            try {
                ...
                controller.insertExpenses(name, amount, employee, date);
